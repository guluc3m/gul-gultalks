ActiveAdmin.register Conference do
  ...
  form do |f|
    f.inputs do
      ...
      f.input :call_for_papers_start_date, label: t("conference.call_for_papers_start_date")
      f.input :call_for_papers_end_date, label: t("conference.call_for_papers_end_date")
      ...
      f.input :call_for_papers_enabled, label: t("conference.status.call_for_papers_enabled"), as: :radio
      f.input :voting_enabled, label: t("conference.status.voting_enabled"), as: :radio
      f.input :show_calendar, label: t("conference.status.show_calendar"), as: :radio
