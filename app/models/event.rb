class Event < ActiveRecord::Base
  extend FriendlyId
  acts_as_taggable
 attr_accessible :accepted, :assisted_by, :cancelled, :conference_id, :content_url, :date, :description, :duration, :end_time, :id, :language, :level, :location, :notes, :room, :shown, :slug, :start_time, :speakers_attributes, :subclass, :summary, :tags, :title, :validation_email, :verified, :votes
